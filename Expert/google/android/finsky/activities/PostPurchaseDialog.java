...
public class PostPurchaseDialog extends AuthenticatedActivity
  implements PageFragmentHost
{
  private CustomActionBar mActionBar;
  private NavigationManager mNavigationManager = new FakeNavigationManager(this);

  public static void show(Context paramContext, String paramString1, int paramInt, String paramString2)
  {
    Intent localIntent = new Intent(paramContext, PostPurchaseDialog.class);
    localIntent.putExtra("purchaseDocUrl", paramString1);
    localIntent.putExtra("offerType", paramInt);
    localIntent.putExtra("accountName", paramString2);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    String str1 = localIntent.getStringExtra("purchaseDocUrl");
    int i = localIntent.getIntExtra("offerType", 1);
    String str2 = localIntent.getStringExtra("accountName");
    ...
    {
      return;
      PostPurchaseFragment localPostPurchaseFragment = PostPurchaseFragment.newInstance(str1, i, str2);
      FragmentTransaction localFragmentTransaction = getSupportFragmentManager().beginTransaction();
      localFragmentTransaction.add(2131230775, localPostPurchaseFragment);
 ...
 * Qualified Name:     com.google.android.finsky.activities.PostPurchaseDialog
