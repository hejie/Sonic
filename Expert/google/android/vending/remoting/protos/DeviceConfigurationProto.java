...
public final class DeviceConfigurationProto extends MessageMicro
{
  ...
  public int getSerializedSize()
  {
    ...
    if (hasDeviceClass())
      i6 += CodedOutputStreamMicro.computeInt32Size(16, getDeviceClass());
    ...
    throws IOException
  {
    while (true)
    {
      ...
      case 122:
        ...
        break;
      case 128:
        setDeviceClass(paramCodedInputStreamMicro.readInt32());
        break;
      case 136:
      }
  ...
  public DeviceConfigurationProto setDeviceClass(int paramInt)
  {
    this.hasDeviceClass = true;
    this.deviceClass_ = paramInt;
    return this;
  }
    ...
    throws IOException
  {
    ...
    if (hasDeviceClass())
      paramCodedOutputStreamMicro.writeInt32(16, getDeviceClass());
    if (hasMaxApkDownloadSizeMb())
 ...
 * Qualified Name:     com.google.android.vending.remoting.protos.DeviceConfigurationProto
